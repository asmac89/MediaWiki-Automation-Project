...
public class UserPageFunctionalitiesStepDefinitions {
	...
	public void i_click_on_edit_tab() {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@When("^I click on edit main page section$")
	public void i_click_on_edit_main_page_section() {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@When("^I edit the section name to \"([^\"]*)\"$")
	...
	@Then("^I should see the topic section for \"([^\"]*)\"$")
	public void i_should_see_the_topic_section_for(String arg1) {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
